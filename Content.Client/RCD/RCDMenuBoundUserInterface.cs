...
public sealed class RCDMenuBoundUserInterface : BoundUserInterface
{
    ...
    private static readonly Dictionary<string, (string Tooltip, SpriteSpecifier Sprite)> PrototypesGroupingInfo
        ...
        {
            ["Straight"] = ("rcd-component-straight", new SpriteSpecifier.Texture(new ResPath("/Textures/Structures/Walls/wooden_fence.rsi/straight.png"))), // Medieval
            ["Furniture"] = ("rcd-component-furniture", new SpriteSpecifier.Texture(new ResPath("/Textures/_DeadSpace/_Medieval/Structures/Storages/cabinets.rsi/cabinet1.png"))), // Medieval
